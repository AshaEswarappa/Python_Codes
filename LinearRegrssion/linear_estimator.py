''' Demonstrates how estimators can be used for regression '''
...
train_input = tf.estimator.inputs.numpy_input_fn( x = {'x_coords': x_train}, y = y_train, num_epochs= num_steps, shuffle = True)
